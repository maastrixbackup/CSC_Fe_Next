...
import img from "@/assets/cta.jpg"; // adjust path if needed
    ...
    >
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold leading-tight drop-shadow-sm">
              {title}
            </h2>
          ...
          >
            <div
              className="w-full max-w-md md:max-w-none overflow-hidden rounded-xl"
