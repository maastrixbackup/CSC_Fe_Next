...
import ReoImg from "@/public/assets/REO Website.jpg";
    ...
    <div className="bg-white text-slate-900">
      <section className="relative w-full overflow-hidden bg-black/25">
        ...
        >
          <Image
            src={ReoImg}
            alt="REO portfolio documentation governance hero background"
            fill
            preload
            sizes="100vw"
        ...
        <div className="relative z-10 flex min-h-[420px] items-center px-6 py-16 sm:min-h-[460px] md:min-h-[540px] lg:px-10">
          ...
          >
            <div className="max-w-[46rem] px-2 sm:px-0 mt-10">
              <motion.div variants={fadeUp}>
                <Link
                  href="/solutions"
                  className="mb-2 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.22em] text-white/80 md:mt-2"
                >
              ...
              >
                In Real Estate, Performance Breaks Down When Documentation
                Isn&apos;t Aligned.
              </motion.h1>
              ...
              >
                Structured documentation governance for REO portfolios and real
                estate operations.
              </motion.p>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold leading-tight md:text-4xl">
                Portfolio-level inconsistency creates performance drift.
              </h2>
              <p className="mt-5 text-lg leading-8 text-slate-600">
                Portfolio-level inconsistency occurs when properties, teams, and
                reporting standards vary. This leads to misaligned decisions and
                performance drift.
              </p>
            </div>
            ...
            <Image
              src={Exegap}
              alt="Execution gap diagram for real estate documentation governance"
      ...
      <section className="bg-[#f8fafc] px-6 py-8">
        <div className="mx-auto max-w-7xl rounded-[28px] bg-[linear-gradient(135deg,#ffffff_0%,#eef4ff_50%,#e0ecff_100%)] p-8 text-gray-900 shadow-[0_20px_50px_rgba(0,0,0,0.08)] md:p-12">
          ...
          <h2 className="mt-4 max-w-7xl text-md font-bold leading-tight md:text-4xl">
            One governance system applied across assets ensures consistent
      ...
      <section className="px-6 py-8">
        <div className="mx-auto max-w-7xl rounded-[28px] border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)] md:p-12">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <Image
              src={Continuity}
              alt="Continuity framework for portfolio documentation governance"
              className="w-full rounded-2xl border border-slate-200 shadow-md"
            />
            ...
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold leading-tight md:text-4xl">
                Structured intake, validation, alignment, and revalidation
                across portfolio workflows.
              </h2>
            </div>
          </div>
        </div>
      ...
      <section className="px-0 pt-4">
        <Cta
          title="Align documentation across your portfolio."
          ctaLabel="Schedule a Consultation"
          compliance="Advisory-only. No asset management, negotiation, or representation services, or third-party communication."
        />
      </section>
    </div>
  );
